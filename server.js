...
app.use('/assets', express.static(__dirname + '/' + staticdir)); // set the static files location /public/img will be /img for users
...
// routes ==================================================
//require('./dev/routes')(app); // configure our routes
